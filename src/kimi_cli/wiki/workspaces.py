...
class WorkspaceRegistry:
    ...
    def _read(self) -> dict[str, dict[str, dict[str, str]]]:
        ...
        return _validate_registry(parsed)

    @staticmethod
    def _id_for_path(data: dict[str, dict[str, dict[str, str]]], path: Path) -> UUID | None:
